...
var account_info_1 = require("./ledger/account-info");
var nickname_1 = require("./ledger/nickname");
var issues_1 = require("./ledger/issues");
var account_invoices_1 = require("./ledger/account-invoices");
...
var CallAPI = /** @class */ (function (_super) {
    ...
    function CallAPI(options) {
        ...
        _this.getAccountByName = nickname_1.default;
        _this.getAccountIssues = issues_1.default;
