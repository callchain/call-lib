...
import {Path, GetPaths, CalledPathsResponse} from '../pathfind-types'
...
function parseAlternative(sourceAddress: string, destinationAddress: string,
  destinationAmount: CalledAmount, alternative: any
): Path {
...
function parsePathfind(pathfindResult: CalledPathsResponse): GetPaths {
